...
manage_satip_connections() {
    ...
    case "$satip_choice" in
        1)
            ...
            ;;
        2) #TODO wenn vtuner über systemd geladen dann formatierung fehler => punkt 2 ( verbindungen deaktivieren ) überarbeiten erzeuge selektiv menu zur auswhal mehrer punkte gleichzeitig
